...
This file is the root-level evidence index for the deployed AWS Managed Grafana observability platform.
...
- The screenshots are assessment evidence, not secrets. Avoid committing screenshots that expose private emails, account IDs, tokens, or sensitive resource names.
